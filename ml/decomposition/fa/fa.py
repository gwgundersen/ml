...
class FA(Model):
    ...
    def __init__(self, derivation='Bishop'):
        if derivation not in ['Bishop', 'Murphy']:
            raise AttributeError('Options for `derivation`: Bishop and Murphy.')
        if derivation == 'Bishop':
            self.E_z_given_v_i  = E_z_given_v_i_Bishop
            self.E_zzT_give_v_i = E_zzT_give_v_i_Bishop
        else:
            self.E_z_given_v_i  = E_z_given_v_i_Murphy
            self.E_zzT_give_v_i = E_zzT_give_v_i_Murphy
